...
### Description:
###
### Analyse particles in monochrome image and returns area of each particle
###Particles should be black (0) and the background metal matrix white
###(1).
###
### Dependencies:
###
...
function area = gron_area(bwimage)
  ...
  s = regionprops(bwimage, "Area");

  area = cat(1, s.Area); # convert list to matrix
